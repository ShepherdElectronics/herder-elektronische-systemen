...
## Personal Regen / DC Bus / VSEN documentation

This folder contains an internal calculation/reference file supporting the TI Piccolo dual-motor PMSM dynamometer documentation. It is provided as engineering working documentation, not as a polished deliverable or production qualification package.
...
The workbook was created to preserve hardware interpretation, test expectations and maintenance knowledge for future laboratory use. Private email drafts, personal tracking notes and unrelated internal source notes are not included in this public repository copy. Workbook formulas are retained.